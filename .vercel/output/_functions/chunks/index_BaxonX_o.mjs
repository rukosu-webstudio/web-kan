!function(){try{var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{};e.SENTRY_RELEASE={id:"d8c12cfbe17f71e1e77220f656d682661c0862ff"};var n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="0fb86217-9fe6-46a9-8787-6745a9ae30fa",e._sentryDebugIdIdentifier="sentry-dbid-0fb86217-9fe6-46a9-8787-6745a9ae30fa");}catch(e){}}();import { $ as $$BaseLayout } from './base-layout_C9nxuYOo.mjs';
import { c as createComponent } from './_astro_assets_CNDdJ4wJ.mjs';
import 'piccolore';
import { T as maybeRenderHead, a4 as addAttribute, b2 as renderSlot, Q as renderTemplate } from './params-and-props_D_OjNncc.mjs';
...
const $$Button = createComponent(($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Button;
  const button = cva(
    "inline-flex items-center justify-center gap-2 rounded-md transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-website-primary focus-visible:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer font-medium",
    {
      variants: {
        variant: {
...
const $$Email = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<svg${addAttribute(`${className}`, "class")} height="800px" width="800px" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve"> <g> <path class="st0" d="M510.678,112.275c-2.308-11.626-7.463-22.265-14.662-31.054c-1.518-1.915-3.104-3.63-4.823-5.345
		...
		V385.92z"></path> </g> </svg>`;
}, "/Users/mpacheco/Documents/projects/PROJECT-web-kan/web-kan/src/components/icons/email.astro", void 0);
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  }, "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate`${maybeRenderHead()}<section class="relative eleven-brand flex flex-col gap-6 items-center justify-center h-screen bg-[#0b0b0b]" data-astro-cid-j7pv25f6><a class="z-10"${addAttribute(BUSINESS_CONFIG.site, "href")} target="_blank" aria-label="Eleven Estudio" title="Link of website of Eleven Estudio" target="_blank" data-astro-cid-j7pv25f6>${renderComponent($$result2, "ElevenEstudio", $$ElevenEstudio, { "class": "w-64 h-auto", "data-astro-cid-j7pv25f6": true })}</a><p class="text-gray-50 font-openSans" data-astro-cid-j7pv25f6>
Get started by editing src/index.astro
</p>${renderComponent($$result2, "Button", $$Button, { "href": "https://github.com/elevenestudio/astro-template-eleven", "target": "_blank", "data-astro-cid-j7pv25f6": true }, { "default": ($$result3) => renderTemplate`Get started` })}${renderComponent($$result2, "SocialMedia", $$SocialMedia, { "class": "flex items-center gap-4 absolute bottom-10 left-1/2 transform -translate-x-1/2", "data-astro-cid-j7pv25f6": true })}</section>` })}`;
